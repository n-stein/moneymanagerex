...
void OptionSettingsGeneral::Create()
{
    ...
    m_currency_history = new wxCheckBox(general_panel, wxID_ANY, _("Use historical currency"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE);
    ...
    m_use_org_date_copy_paste = new wxCheckBox(general_panel, wxID_ANY, _("Use Original Date when Pasting Transactions"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE);
    ...
    m_use_org_date_duplicate = new wxCheckBox(general_panel, wxID_ANY, _("Use Original Date when Duplicating Transactions"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE);
