 ...
 ********************************************************/
#ifndef MM_EX_STOCKSETTINGS_H_
#define MM_EX_STOCKSETTINGS_H_
...
{
public:
    mmStockSetup(wxWindow* parent, int64 ticker_id, int64 account_id);

    ~mmStockSetup();
    const wxString getSymbol() const;
    const int64 get_ticker_id() const;
...
inline const int64 mmStockSetup::get_ticker_id() const { return m_ticker_id; }
