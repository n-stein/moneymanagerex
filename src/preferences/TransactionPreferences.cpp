...
#include "TransactionPreferences.h"
...
TransactionPreferences::TransactionPreferences(wxWindow *parent
    , wxWindowID id
    , const wxPoint &pos
    , const wxSize &size
    , long style, const wxString &name) : TransactionPreferences()
{
...
void TransactionPreferences::Create()
{
    ...
    defaultCategoryTransferChoice->SetSelection(PreferencesModel::instance().getTransCategoryTransferNone());

    wxChoice* defaultDateChoice = new wxChoice(transSettingsStaticBox
        , ID_DIALOG_OPTIONS_DEFAULT_TRANSACTION_DATE
        , wxDefaultPosition, wxDefaultSize, default_values);
    defaultDateChoice->SetSelection(PreferencesModel::instance().getTransDateDefault());
    ...
    wxChoice* defaultPayeeChoice = new wxChoice(transSettingsStaticBox
        ...
        , wxDefaultPosition, wxDefaultSize, default_values);
    defaultPayeeChoice->SetSelection(PreferencesModel::instance().getTransPayeeNone());
    ...
    wxChoice* defaultCategoryNonTransferChoice = new wxChoice(transSettingsStaticBox
        ...
        , wxDefaultPosition, wxDefaultSize, default_values);
    defaultCategoryNonTransferChoice->SetSelection(PreferencesModel::instance().getTransCategoryNone());
    ...
    default_status->SetSelection(PreferencesModel::instance().getTransStatusReconciled());
    ...
    newTransflexGridSizer->Add(new wxStaticText(transSettingsStaticBox, wxID_STATIC, _t("Default Date")), g_flagsH);
    newTransflexGridSizer->Add(defaultDateChoice, g_flagsExpand);
    newTransflexGridSizer->Add(new wxStaticText(transSettingsStaticBox, wxID_STATIC, _t("Default Payee")), g_flagsH);
    newTransflexGridSizer->Add(defaultPayeeChoice, g_flagsExpand);
    newTransflexGridSizer->Add(new wxStaticText(transSettingsStaticBox, wxID_STATIC, _t("Default Deposit/Withdrawal Category")), g_flagsH);
    newTransflexGridSizer->Add(defaultCategoryNonTransferChoice, g_flagsExpand);
    newTransflexGridSizer->Add(new wxStaticText(transSettingsStaticBox, wxID_STATIC, _t("Default Transfer Category")), g_flagsH);
    newTransflexGridSizer->Add(defaultCategoryTransferChoice, g_flagsExpand);
    newTransflexGridSizer->Add(new wxStaticText(transSettingsStaticBox, wxID_STATIC, _t("Default Status")), g_flagsH);
    ...
    transactionCopyStaticBoxSizer->Add(soundBaseSizer, wxSizerFlags(g_flagsV).Border(wxLEFT, 0));
    soundBaseSizer->Add(new wxStaticText(transactionCopyStaticBox, wxID_STATIC, _t("Transaction Sound")), g_flagsH);
    m_use_sound = new wxChoice(transactionCopyStaticBox, wxID_STATIC
    ...
    m_budget_financial_years->SetValue(PreferencesModel::instance().getBudgetFinancialYears());
    ...
    m_budget_include_transfers->SetValue(PreferencesModel::instance().getBudgetIncludeTransfers());
    ...
    m_budget_summary_without_category->SetValue(PreferencesModel::instance().getBudgetSummaryWithoutCategories());
    ...
    m_budget_override->SetValue(PreferencesModel::instance().getBudgetOverride());
    ...
    m_budget_deduct_monthly->SetValue(PreferencesModel::instance().getBudgetDeductMonthly());
    ...
    trxChoiceSizer->Add(new wxStaticText(trxBox, wxID_STATIC, _t("Budget Offset (days)")), g_flagsH);
    m_budget_days_offset = new wxSpinCtrl(
        trxBox, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
    ...
    m_budget_days_offset->SetValue(PreferencesModel::instance().getBudgetDaysOffset());
    trxChoiceSizer->Add(m_budget_days_offset, g_flagsH);

    trxChoiceSizer->Add(new wxStaticText(trxBox, wxID_STATIC, _t("First Day of Month")), g_flagsH);
    ...
    m_reporting_firstday->SetValue(PreferencesModel::instance().getReportingFirstDay());
    trxChoiceSizer->Add(m_reporting_firstday, g_flagsH);

    trxChoiceSizer->Add(new wxStaticText(trxBox, wxID_STATIC, _t("First Weekday")), g_flagsH);
    m_reporting_first_weekday = new wxChoice(trxBox, wxID_ANY);
    ...
    m_reporting_first_weekday->SetSelection(PreferencesModel::instance().getReportingFirstWeekday());
    ...
    m_ignore_future_transactions->SetValue(PreferencesModel::instance().getIgnoreFutureTransactions());
    ...
    m_use_trans_date_time->SetValue(PreferencesModel::instance().UseTransDateTime());
    ...
    m_treat_date_as_SN->SetValue(PreferencesModel::instance().TreatDateAsSN());
    ...
    SetBoldFontToStaticBoxHeader(transactionCopyStaticBox);
    SetBoldFontToStaticBoxHeader(trxBox);
    SetBoldFontToStaticBoxHeader(colorsBox);
    ...
    this->Connect(
        ...
        wxCommandEventHandler(TransactionPreferences::OnNavTreeColorChanged),
        nullptr, this
    );
}

bool TransactionPreferences::SaveSettings()
{
    ...
    PreferencesModel::instance().setBudgetFinancialYears(m_budget_financial_years->GetValue());
    PreferencesModel::instance().setBudgetIncludeTransfers(m_budget_include_transfers->GetValue());
    PreferencesModel::instance().setBudgetSummaryWithoutCategories(m_budget_summary_without_category->GetValue());
    PreferencesModel::instance().setBudgetOverride(m_budget_override->GetValue());
    PreferencesModel::instance().setBudgetDeductMonthly(m_budget_deduct_monthly->GetValue());
    PreferencesModel::instance().setBudgetDaysOffset(m_budget_days_offset->GetValue());
    PreferencesModel::instance().setReportingFirstDay(m_reporting_firstday->GetValue());
    PreferencesModel::instance().setReportingFirstWeekday(
        static_cast<wxDateTime::WeekDay>(m_reporting_first_weekday->GetSelection())
    );
    PreferencesModel::instance().setIgnoreFutureTransactions(m_ignore_future_transactions->GetValue());
    PreferencesModel::instance().UseTransDateTime(m_use_trans_date_time->GetValue());
    PreferencesModel::instance().TreatDateAsSN(m_treat_date_as_SN->GetValue());
    ...
    InfotableModel::instance().setColour("USER_COLOR1", mmColors::userDefColor1);
    InfotableModel::instance().setColour("USER_COLOR2", mmColors::userDefColor2);
    InfotableModel::instance().setColour("USER_COLOR3", mmColors::userDefColor3);
    InfotableModel::instance().setColour("USER_COLOR4", mmColors::userDefColor4);
    InfotableModel::instance().setColour("USER_COLOR5", mmColors::userDefColor5);
    InfotableModel::instance().setColour("USER_COLOR6", mmColors::userDefColor6);
    InfotableModel::instance().setColour("USER_COLOR7", mmColors::userDefColor7);

    wxChoice* itemChoice = static_cast<wxChoice*>(FindWindow(ID_DIALOG_OPTIONS_DEFAULT_TRANSACTION_PAYEE));
    PreferencesModel::instance().setTransPayeeNone(itemChoice->GetSelection());

    itemChoice = static_cast<wxChoice*>(FindWindow(ID_DIALOG_OPTIONS_DEFAULT_TRANSACTION_CATEGORY_NONTRANSFER));
    PreferencesModel::instance().setTransCategoryNone(itemChoice->GetSelection());

    itemChoice = static_cast<wxChoice*>(FindWindow(ID_DIALOG_OPTIONS_DEFAULT_TRANSACTION_CATEGORY_TRANSFER));
    PreferencesModel::instance().setTransCategoryTransferNone(itemChoice->GetSelection());

    itemChoice = static_cast<wxChoice*>(FindWindow(ID_DIALOG_OPTIONS_DEFAULT_TRANSACTION_STATUS));
    PreferencesModel::instance().setTransStatusReconciled(itemChoice->GetSelection());

    itemChoice = static_cast<wxChoice*>(FindWindow(ID_DIALOG_OPTIONS_DEFAULT_TRANSACTION_DATE));
    PreferencesModel::instance().setTransDateDefault(itemChoice->GetSelection());

    return true;
}

void TransactionPreferences::OnNavTreeColorChanged(wxCommandEvent& event)
{
